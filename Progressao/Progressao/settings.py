...
SECRET_KEY = 'django-insecure-uc@90ilaz__@w0^hilvc&s5uqn_r5&($%8sjh-*84(qsrv5jbk'
...
# Incluído adicionalmente para que encontre a rota da pasta "static". 
# Só com a configuração STATIC_URL não funciona.
STATICFILES_DIRS = [
